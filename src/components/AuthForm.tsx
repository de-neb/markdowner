...
export default function AuthForm() {
  ...
  return (
    <fetcher.Form
      ...
      className="flex flex-col gap-4 w-full max-w-sm bg-white/10 rounded-md shadow-lg bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 border border-white/20 p-7"
    >
